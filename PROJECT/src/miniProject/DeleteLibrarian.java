	...
	DeleteLibrarian()
	{
	  ...
	  public void actionPerformed(ActionEvent ae) {
        ...
        //statement.execute(database);
		  ...
		  String delete="Delete from Librarian_details where L_id="+li+";";
		
         int res=statement.executeUpdate(delete);
		  
		  if(res==0){
			  JOptionPane.showMessageDialog(DeleteLibrarian.this, "Sorry, Unable to delete","Error!", JOptionPane.ERROR_MESSAGE);
	 ...
	 SwingUtilities.invokeLater(new Runnable() {
			public void run()
			{
				 DeleteLibrarian myFrame = new DeleteLibrarian();
