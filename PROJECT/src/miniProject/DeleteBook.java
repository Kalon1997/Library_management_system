	...
	DeleteBook()
	{
	  ...
	  public void actionPerformed(ActionEvent ae) {
        ...
        //statement.execute(database);
		  ...
		  String delete="Delete from addbook where B_id="+li+";";
		
         int res=statement.executeUpdate(delete);
		  
		  if(res==0){
			  JOptionPane.showMessageDialog(DeleteBook.this, "Sorry, Unable to delete","Error!", JOptionPane.ERROR_MESSAGE);
	 ...
	 SwingUtilities.invokeLater(new Runnable() {
			public void run()
			{
				DeleteBook myFrame = new DeleteBook();
