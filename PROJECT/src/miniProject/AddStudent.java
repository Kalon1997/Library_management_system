...
public class AddStudent extends JFrame {
	...
	AddStudent()
	{
		JLabel background=new JLabel(new ImageIcon("F:\\DOC\\SEM-5\\eclipse-workspace\\PROJECT\\src\\miniProject\\bo.jpg"));
	     ...
	     JLabel Bid=new JLabel("Student's ID");
	     JLabel Bname=new JLabel("Student Name");
	     JLabel Bqty=new JLabel("Books taken");
	  ...
	  public void actionPerformed(ActionEvent ae) {
        ...
        //statement.execute(database);
		  ...
		  String insert="Insert into addstudent values("+bi+",'"+bn+"',"+bq+");";
		
          statement.executeUpdate(insert);
		  
		  if(bn.equals("")){
			  JOptionPane.showMessageDialog(AddStudent.this, "Sorry, Enter all the values","Login Error!", JOptionPane.ERROR_MESSAGE);
	 ...
	 SwingUtilities.invokeLater(new Runnable() {
			public void run()
			{
				AddStudent myFrame = new AddStudent();
